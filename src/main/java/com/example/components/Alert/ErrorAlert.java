...
public class ErrorAlert extends BaseModalController implements Initializable{
    ...
    public ErrorAlert(String title, double width, double height, Node parent_source, String alert_msg) throws IOException {
        super(title, width, height, parent_source, "component/alert/error_alert.fxml");
        
        //Agar dapat memberi value ke variabel alert_msg dalam fxml, maka harus melalui controller
        ErrorAlert current = super.loader.getController();
        current.setAlertMsg(alert_msg);
        this.title = title;
    }
    
    public ErrorAlert(String title, Node parent_source, String alert_msg) throws IOException {
        super(title, parent_source, "component/alert/error_alert.fxml");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        this.icon.setImage(new Image(getClass().getResource("/assets/img/icons/error_icon.png").toExternalForm()));
